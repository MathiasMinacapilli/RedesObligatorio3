...
******************************************************************/
  ...
  RouterSimulator()                         /* initialize the simulator */
  {
    ...
    connectcosts[0][1]=1;
    connectcosts[0][2]=INFINITY;
    connectcosts[0][3]=2;
    connectcosts[0][4]=INFINITY;
    connectcosts[0][5]=INFINITY;
    connectcosts[0][6]=INFINITY;
    connectcosts[0][7]=INFINITY;
    connectcosts[1][0]=1;
    connectcosts[1][2]=2;
    connectcosts[1][3]=INFINITY;
    connectcosts[1][4]=INFINITY;
    connectcosts[1][5]=INFINITY;
    connectcosts[1][6]=INFINITY;
    connectcosts[1][7]=INFINITY;
    connectcosts[2][0]=INFINITY;
    connectcosts[2][1]=2;
    connectcosts[2][3]=4;
    connectcosts[2][4]=1;
    connectcosts[2][5]=6;
    connectcosts[2][6]=INFINITY;
    connectcosts[2][7]=INFINITY;
    connectcosts[3][0]=2;
    connectcosts[3][1]=INFINITY;
    connectcosts[3][2]=4;
    connectcosts[3][4]=INFINITY;
    connectcosts[3][5]=INFINITY;
    connectcosts[3][6]=INFINITY;
    connectcosts[3][7]=INFINITY;
    connectcosts[4][0]=INFINITY;
    connectcosts[4][1]=INFINITY;
    connectcosts[4][2]=1;
    connectcosts[4][3]=INFINITY;
    connectcosts[4][5]=8;
    connectcosts[4][6]=INFINITY;
    connectcosts[4][7]=3;
    connectcosts[5][0]=INFINITY;
    connectcosts[5][1]=INFINITY;
    connectcosts[5][2]=6;
    connectcosts[5][3]=INFINITY;
    connectcosts[5][4]=8;
    connectcosts[5][6]=3;
    connectcosts[5][7]=2;
    connectcosts[6][0]=INFINITY;
    connectcosts[6][1]=INFINITY;
    connectcosts[6][2]=INFINITY;
    connectcosts[6][3]=INFINITY;
    connectcosts[6][4]=INFINITY;
    connectcosts[6][5]=3;
    connectcosts[6][7]=1;
    connectcosts[7][0]=INFINITY;
    connectcosts[7][1]=INFINITY;
    connectcosts[7][2]=INFINITY;
    connectcosts[7][3]=INFINITY;
    connectcosts[7][4]=3;
    connectcosts[7][5]=2;
    connectcosts[7][6]=1;
