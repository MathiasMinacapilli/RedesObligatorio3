...
******************************************************************/
  ...
  RouterSimulator()                         /* initialize the simulator */
  {
    ...
    connectcosts[2][0]=2;  
    connectcosts[2][1]=3;
    connectcosts[2][3]=INFINITY;
    connectcosts[2][4]=INFINITY;
    connectcosts[2][5]=INFINITY;
    connectcosts[3][0]=INFINITY;
    connectcosts[3][1]=INFINITY;
    connectcosts[3][2]=INFINITY;
    connectcosts[3][4]=7;
    connectcosts[3][5]=8;
    connectcosts[4][0]=INFINITY;
    connectcosts[4][1]=INFINITY;
    connectcosts[4][2]=INFINITY;
    connectcosts[4][3]=7;
    connectcosts[4][5]=9;
    connectcosts[5][0]=INFINITY;
    connectcosts[5][1]=INFINITY;
    connectcosts[5][2]=INFINITY;
    connectcosts[5][3]=8;
    connectcosts[5][4]=9;
